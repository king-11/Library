...
genre = [ 'Fiction', 'Non-Ficton', 'Mystery', 'Self Help', 'Biography', 'Fantasy', 'Manga', 'Comedy', 'Philosophy', 'Poetry', 'Spirituality' ]
...
function setContent(book, id) {
    ...
    cardText.innerHTML = `The Genre of this book is ${book.pages.bold()} and it was recommended by : ${book.read.bold()}.`
    ...
    let cont = document.getElementById(book.pages)
