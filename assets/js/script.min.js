...
function setContent(book, id) {
  ...
  let linked = document.createElement("p");
  ...
  ref.setAttribute("style", "max-width:fit-content");

  image.setAttribute("style", "max-width:95%; margin: auto; margin-top:0");
  linked.innerHTML = `<p>The Genre of this book is ${book.pages.bold()} and it was recommended by : ${book.read.bold()}.</p>`;
  linked.appendChild(ref);
  cardText.appendChild(linked);
