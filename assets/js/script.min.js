...
function setContent(book, id) {
  ...
  image.setAttribute("style", "max-width:95%; margin: auto auto");
  cardText.innerHTML = `<p>The Genre of this book is ${book.pages.bold()} and it was recommended by : ${book.read.bold()}.</p>`;
